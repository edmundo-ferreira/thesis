...
\hypersetup{
            colorlinks,       % color text of links and anchors,
...
\newlength\mytemplen
\newsavebox\mytempbox
\definecolor{myblue}{rgb}{.95, .95, 1}
\makeatletter
\newcommand\mybluebox{%
    \@ifnextchar[%]
       {\@mybluebox}%
...
\def\@@mybluebox[#1][#2]#3{
    ...
    \colorbox{myblue}{\hspace{2mm}\usebox{\mytempbox}\hspace{2mm}}}
\makeatother
